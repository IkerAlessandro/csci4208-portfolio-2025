...
| Item | Key | Status |
|---|---|---|
| Capstone-01 — Find a Team [#5](https://github.com/IkerAlessandro/csci4208-portfolio-2025/issues/5) | `capstone-01` | closed |
...
| Project-0 — Set up Repo, Project Board, Actions & Pages [#8](https://github.com/IkerAlessandro/csci4208-portfolio-2025/issues/8) | `project-00` | approved |
| Project-01 — Interactive Game in HTML & CSS [#4](https://github.com/IkerAlessandro/csci4208-portfolio-2025/issues/4) | `project-01` | closed |
